    ...
    <div class="p-4 bg-slate-800 border-b border-slate-700">
        <div class="flex items-center gap-4 mb-3">
            ...
            <div class="flex items-center gap-4 ml-4">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-bold text-white"><?php echo e(number_format($stats['total'])); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-400">Con stock:</span>
                    <span class="text-sm font-bold text-green-400"><?php echo e(number_format($stats['con_stock'])); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-400">Sin stock:</span>
                    <span class="text-sm font-bold text-orange-400"><?php echo e(number_format($stats['sin_stock'])); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="text-xs text-slate-400">Valor:</span>
                    <span class="text-sm font-bold text-blue-400">$<?php echo e(number_format($stats['valor_total'], 2)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <button
                ...
                class="px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e($soloConStock ? 'bg-blue-600 text-white' : 'bg-slate-900 text-slate-400 hover:bg-slate-700 border border-slate-700'); ?>"
            >
                <div class="flex items-center gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="hover:bg-slate-800 transition-colors">
                            ...
                            <td class="px-3 py-2">
                                ...
                                ?>
                                <div class="w-16 h-16 <?php echo e($colorSet['bg']); ?> rounded flex items-center justify-center border border-slate-600 overflow-hidden relative">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($producto->imagen_url): ?>
                                        <img
                                            src="<?php echo e($producto->imagen_url); ?>"
                                            alt="<?php echo e($producto->nombre); ?>"
                                            class="absolute inset-0 w-full h-full object-cover z-10"
                                            onerror="this.src='<?php echo e(asset('images/product-placeholder.svg')); ?>'; this.classList.remove('z-10');"
                                        >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('images/product-placeholder.svg')); ?>" alt="<?php echo e($producto->nombre); ?>" class="w-full h-full object-cover">
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <!-- Código -->
                            <td class="px-3 py-2 text-slate-300 font-mono text-xs">
                                <?php echo e($producto->codigo_interno ?? $producto->codigo_barras ?? '-'); ?>
                            ...
                            <!-- Grupo -->
                            <td class="px-3 py-2 text-slate-400">
                                <?php echo e($producto->n_grupo ?? '-'); ?>

                            </td>
                            <!-- Stock -->
                            <td class="px-3 py-2 text-right font-semibold <?php echo e($producto->stock > 0 ? 'text-green-400' : 'text-red-400'); ?>">
                                <?php echo e(number_format($producto->stock)); ?>

                            </td>
                            <!-- Precio -->
                            <td class="px-3 py-2 text-right font-semibold text-blue-400">
                                $<?php echo e(number_format($producto->getPrecioEfectivo(), 0, ',', '.')); ?>

                            </td>
                            <!-- Valor Total -->
                            <td class="px-3 py-2 text-right font-semibold text-slate-300">
                                $<?php echo e(number_format($producto->stock * $producto->getPrecioEfectivo(), 0, ',', '.')); ?>
...
<?php /**PATH C:\MisLaravel\pos\resources\views/livewire/pos/productos.blade.php ENDPATH**/ ?>