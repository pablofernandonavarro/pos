...
return [
    ...
    'cleanup_exclude_files' => [
        ...
        'node_modules',
        '*/tests',
        // Del repo: no hacen falta dentro de la app instalada.
        'tests',
        'phpunit.xml',
        'parches',
        '.env.example',
        '.env.escritorio.example',
        '*.bat',
        '*.ps1',
        '*.vbs',
    ],
    ...
    'queue_workers' => [
        'default' => [
            'queues' => ['default'],
            'memory_limit' => 128,
            // 120 y no 60: ManagerApiService usa timeout(30)->retry(3), o sea hasta ~90s
            // cuando el Manager no responde. Con 60 el worker mataba el job a mitad de
            // los reintentos y la venta quedaba sin enviar hasta el próximo intento.
            'timeout' => 120,
            'sleep' => 3,
        ],
    ],
